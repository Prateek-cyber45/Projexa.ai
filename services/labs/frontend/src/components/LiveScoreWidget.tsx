                ...
                <div className="space-y-4">
                    <div>
                        <div className="flex justify-between text-xs font-sans font-semibold mb-1">
                            ...
                            <span className="text-[var(--color-brand-blue)] bg-blue-50 px-2 py-0.5 rounded-full border border-blue-100">{skillLabel}</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="w-full bg-[var(--color-border-subtle)] rounded-full h-1.5 overflow-hidden">
                            <div
                                className="bg-[var(--color-text-primary)] h-1.5 rounded-full transition-all duration-1000 ease-out"
